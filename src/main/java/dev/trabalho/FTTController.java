...
public class FTTController extends SimpleController {

    private int checkWhichCellHasMoreH3(Cell northCell,Cell westCell,Cell eastCell,Cell southCell){
        float bigger;
        int checkWhich=1;
    ...
    private int FTTControllerLogic(Robo robo){
        ...
        if(prospection != null){
            if(prospection.isReady()){
                while(walk == null) {
                    ...
                    switch (FTTControllerLogic(robo)) {
                        case 1:
                            break;
                        case 2:
                            robo.turnLeft();
    ...
    public FTTController(RoboFTT robo){
        super(robo);
    }
}
